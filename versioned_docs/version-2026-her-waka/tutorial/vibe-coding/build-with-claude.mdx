...
<Tabs>
  ...
  <Tab title="Type or paste">
    Copy any prompt from this page and paste it into Claude Code. Or type your own request in natural language. No special syntax needed — just describe what you want.
  </Tab>
</Tabs>
...
**Open your terminal, `cd` into your `daily-report-bot` folder, and type `claude` to start Claude Code. Then say or send this prompt:**
...
<AccordionGroup>
  ...
  <Accordion title="Speaking works well for describing features">
...
<Note>
Your bot is built! Head to [Deploy and test](/docs/2026-her-waka/tutorial/vibe-coding/deploy-and-test) to set up GitHub Actions and see it run for real.
</Note>
