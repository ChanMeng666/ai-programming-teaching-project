...
description: "Install Gemini CLI and Google Workspace CLI — connect AI to your Google Calendar and Gmail."
---
...
<Steps>
  ...
  <Step title="Connect Gemini CLI to gws">
    Now let's give Gemini CLI the ability to use `gws` — so it can read your calendar and email when you ask.
  ...
  <Step title="Test the connection">
    ...
    **Gemini asks for permission?** If Gemini CLI asks to approve a tool call, type `y` and press **Enter**. This is normal — it is asking your permission before accessing your Google data.
    ...
    <Accordion title="Gemini says it has no calendar tools">
...
<AccordionGroup>
  ...
  <Accordion title="Connection tested">
    Gemini CLI can tell you about your meetings when you ask "What meetings do I have today?"
  </Accordion>
</AccordionGroup>

<Note>
All set? Head to [Get your morning briefing](/docs/2026-her-waka/tutorial/morning-briefing/briefing) to start your first AI-powered morning routine.
</Note>
