...
<CardGroup cols={3}>
  ...
  <Card title="Obsidian with CLI enabled" icon="notebook">
    If you completed the [Voice-Control Your Notes](/docs/2026-her-waka/tutorial/obsidian-daily/overview) tutorial, you are already set up. Otherwise, we will walk you through it.
  </Card>
</CardGroup>

<Note>
Ready to get started? Head to [Set up your tools](/docs/2026-her-waka/tutorial/obsidian-organise/setup) to get everything ready.
</Note>
