...
<Tip>
**Already set up?** If you completed the [Voice-Control Your Notes](/docs/2026-her-waka/tutorial/obsidian-daily/overview) tutorial, you are already set up! Skip to Step 5 to check your vault.
</Tip>
...
<Note>
All set? Head to [Search, audit, and organise](/docs/2026-her-waka/tutorial/obsidian-organise/organise) to start exploring your vault.
</Note>
