...
description: "Connect AI to your Slack workspace — install Gemini CLI with voice commands (recommended) or try the quick Claude Desktop alternative."
---
...
<Tabs>
  <Tab title="Recommended: CLI + Voice">
    ...
    <Note>
    All set? Head to [Summarise your Slack channels](/docs/2026-her-waka/tutorial/slack-summary/summarize) to get your first AI-powered summary.
    </Note>
  </Tab>
