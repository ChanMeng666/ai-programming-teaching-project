...
<PdfDownload
  href="/pdfs/technest/curriculum-outline.pdf"
  title="Curriculum Outline — Printable Handout"
  description="The full 12-week TECHNEST AI Track in one PDF: goals, delegation rules, weekly plan, required tools, assessment, and capstone evaluation criteria."
  size="586 KB"
/>
...
Every week of the track ships with a typeset PDF handout — pixel-perfect, print-ready, generated from the same Typst sources that power the website. Download a single week's handout, the curriculum overview, or the capstone spec.

<PdfDownload
  href="/pdfs/technest/curriculum-outline.pdf"
  title="Curriculum Outline"
  description="The 12-week track at a glance — goals, delegation rules, weekly plan, assessment, capstone evaluation."
  size="586 KB"
/>
...
<PdfDownload
  ...
  description="Install Cursor, Claude Code, Gemini CLI, MCP servers, and Skills. Run your first AI-driven Vercel deploy."
  size="623 KB"
/>
...
<PdfDownload
  ...
  description="Fork the Magic Portfolio template, customise via Cursor, and ship to production with the Vercel CLI."
  size="628 KB"
/>
...
<PdfDownload
  ...
  description="Wire Gemini 2.5 Flash into a floating chat widget driven by your own persona system prompt."
  size="647 KB"
/>

<PdfDownload
  href="/pdfs/technest/week-04-fullstack-neon.pdf"
  title="Week 4 — Go Full-Stack: Neon + Auth"
  description="Provision Neon Postgres + Neon Auth via MCP, add a guestbook, and let Drizzle manage the schema."
  size="679 KB"
/>

<PdfDownload
  href="/pdfs/technest/week-05-vercel-blob.pdf"
  title="Week 5 — Image Uploads with Vercel Blob"
  description="Extend the guestbook so visitors can attach images. Secure upload tokens, blob-storage cost-thinking."
  size="649 KB"
/>

<PdfDownload
  href="/pdfs/technest/week-06-blog-system.pdf"
  title="Week 6 — Blog System"
  description="Add a /blog section using a Vercel template — MDX posts, syntax-highlighted code blocks, RSS feed."
  size="655 KB"
/>
...
<PdfDownload
  ...
  description="Build a contact form. On submission, persist to Neon and fire a Slack webhook in real time."
  size="672 KB"
/>
...
<PdfDownload
  ...
  description="Generate a pixel-perfect CV and tailored cover letter from your Neon profile via the Typst skill."
  size="675 KB"
/>

<PdfDownload
  href="/pdfs/technest/capstone.pdf"
  title="Capstone Specification (Weeks 9–12)"
  description="Team formation, three tracks, non-negotiable requirements, timeline, and Demo Day rubric."
  size="604 KB"
/>
