...
### Phase 2 — Install Typst skill in Claude Code
...
| Docs | Videos | Repos |
|---|---|---|
| Typst — getting started + language reference | Instructor demo: "Your CV as code in 20 minutes" | `typst/typst` — compiler source |
| Anthropic Skills — Typst skill | | `anthropics/skills` — Typst skill examples |
