...
<PdfDownload
  ...
  title="Week 5 Handout — Printable PDF"
  description="The full Week 5 lecture handout: direct-to-CDN uploads with signed tokens, content-type filtering, client-side compression."
  size="649 KB"
/>
