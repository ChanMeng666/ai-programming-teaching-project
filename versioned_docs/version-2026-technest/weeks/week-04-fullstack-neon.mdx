...
<PdfDownload
  ...
  title="Week 4 Handout — Printable PDF"
  description="The full Week 4 lecture handout: Neon Postgres + Neon Auth via MCP, Drizzle schema, Google OAuth, signed-in guestbook."
  size="679 KB"
/>
