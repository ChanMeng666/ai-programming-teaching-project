...
Find manual tool installation tedious? Use Gemini CLI to do it for you! See our [Gemini CLI Environment Management course](/docs/2025-summer/basics/).
</Admonition>
...
### Online Courses
- [AI Programming Open Course](/docs/2025-summer/intro/) - Our free course series
- [Gemini CLI Basic Tutorial](/docs/2025-summer/basics/) - Systematic Gemini CLI learning
- [Personal Website Development](/docs/2025-summer/website/) - Hands-on project
...
Start now:
1. Check out our [Course Introduction](/docs/2025-summer/intro/)
...
Ready? Begin with [Gemini CLI Environment Management](/docs/2025-summer/basics/) or join our [Discord Community](https://discord.gg/T3NJG5n98a) to connect with other learners!
:::
