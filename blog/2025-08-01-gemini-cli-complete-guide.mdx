...
想要更深入地学习 Gemini CLI 的使用？欢迎查看我们的 [Gemini CLI 环境管理课程](/docs/2025-summer/basics/)，通过实践项目系统性地掌握这一工具。

---

:::info 相关资源
- [课程一：Gemini CLI 环境管理](/docs/2025-summer/basics/) - 系统性学习 Gemini CLI
- [课程二：开发并部署个人网站](/docs/2025-summer/website/) - 用 AI 搭建个人网站
