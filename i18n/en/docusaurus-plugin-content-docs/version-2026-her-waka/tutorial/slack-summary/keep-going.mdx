...
<CardGroup cols={2}>
  ...
  <Card title="Export as a PDF" icon="file-pdf">
    Combine this tutorial with the [Create Professional PDFs](/docs/2026-her-waka/tutorial/professional-pdf/overview) tutorial — summarise a channel, then use Gemini CLI + Typst to create a beautifully formatted PDF report.
  </Card>
</CardGroup>
