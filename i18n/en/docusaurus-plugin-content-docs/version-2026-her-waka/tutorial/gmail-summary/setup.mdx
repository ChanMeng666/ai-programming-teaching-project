...
description: "Connect AI to your Gmail account — install Gemini CLI + Voice (recommended) or try the quick browser preview."
---
...
<Tabs>
  <Tab title="Full Tutorial (CLI + Voice)">
    ...
    <Note>
    All set? Head to [Summarise your Gmail](/docs/2026-her-waka/tutorial/gmail-summary/summarize) to get your first AI-powered email summary.
    </Note>
  </Tab>
