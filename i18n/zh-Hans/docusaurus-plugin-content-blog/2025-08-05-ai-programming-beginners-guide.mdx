...
如果你觉得手动安装这些工具太麻烦，可以直接使用 Gemini CLI 帮你完成！详见我们的 [Gemini CLI 环境管理课程](/docs/2025-summer/basics/)。
</Admonition>
...
- [AI 编程公开课](/docs/2025-summer/intro/) — 我们的免费课程系列，从环境搭建到网站部署
- [Gemini CLI 基础教程](/docs/2025-summer/basics/) — 系统学习 Gemini CLI
- [个人网站开发部署](/docs/2025-summer/website/) — 动手做项目
...
1. 打开我们的 [课程介绍](/docs/2025-summer/intro/)
2. 按照指引搭建开发环境
3. 完成你的第一个 AI 辅助项目
...
:::info 开始你的 AI 编程之旅
准备好了吗？从 [Gemini CLI 环境管理](/docs/2025-summer/basics/) 开始你的第一步，或者加入我们的 [Discord 社区](https://discord.gg/T3NJG5n98a) 与其他学习者交流！
:::
